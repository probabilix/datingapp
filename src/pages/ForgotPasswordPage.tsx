          ...
          {!submitted ? (
            <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
              <input 
                ...
                required 
                className="w-full px-5 py-4 rounded-xl bg-[#F9F9F9] outline-none focus:ring-1 focus:ring-[#E94057]/20 transition-all text-[#12172D]" 
              />
              <button 
                type="submit" 
                className="w-full py-4 rounded-xl text-white font-bold shadow-lg transition-all hover:brightness-110 active:scale-[0.98]" 
