          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-8">
            {stepsData.map((step) => (
              <div key={step.id} className="relative">
                ...
                {/* THE CARD */}
                <div
                  className="rounded-[15px] px-8 py-8 md:pt-4 md:pb-4 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.04)] h-full flex flex-col items-start transition-transform hover:-translate-y-1"
                  style={{
